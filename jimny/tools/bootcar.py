...
# JB74 Sierra, published: 3550 long (the last 130 is the tailgate spare, which
# is left off a side outline), 1730 tall over the roof rails, 2250 wheelbase,
# 640 front overhang. Everything else is read off the model at those anchors.
LEN, TALL = 3420.0, 1690.0
...
BELT, HEAD = 1120.0, 1620.0          # window sill and the roof rail's inner edge
...
body = (
    ...
    poly([(AXLE_F - ARCH_DZ, 400), (20, 410), (0, 500), (0, 690), (30, 720), (30, 1070),
          ...
          (1155, TALL), (3320, TALL), (LEN, 1610), (LEN, 560),
          # rear bumper, then forward along the bottom through both arches
          (3395, 540), (3395, 415), (3310, 395)], close=False)
...
windows = [
    ...
    poly([(2290, HEAD), (3180, HEAD), (3180, BELT), (2290, BELT)]),
]
