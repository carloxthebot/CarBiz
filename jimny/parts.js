...
export const REAR_BUMPERS = [
  ...
  // ---- 日本
  { id: 'wildgoose_crawler_rear', photo: true, ownLamps: true, url: 'https://www.rv4wildgoose.com/parts/jimny-64-74/rear_bumper_64/jm-1103.html', label: 'Crawler 圓管後保桿 JM-1103', price: 66000, cur: 'JPY', brand: 'RV4 Wild Goose',
  ...
  { id: 'wildgoose_box_rear', photo: true, ownLamps: true, url: 'https://www.rv4wildgoose.com/parts/jimny-64-74/rear_bumper_64/jm-1101.html', label: '角管越野後保桿 JM-1101', price: 95700, cur: 'JPY', brand: 'RV4 Wild Goose',
  ...
  { id: 'showa_iron_rear', photo: true, ownLamps: true, url: 'https://www.showa-garage.shop/shopdetail/000000000843/', refs: ['https://www.showa-garage.shop/shopbrand/ct343/'], label: 'Iron Bumper 鋼管後保桿', price: 62150, cur: 'JPY', brand: 'SHOWA GARAGE',
  ...
  { id: 'taniguchi_rear_pipe', photo: true, ownLamps: true, url: 'https://www.ors-taniguchi.co.jp/parts-cat/jb_exterior_rear/', label: '鋼管越野後保桿', price: 63800, cur: 'JPY', brand: 'TANIGUCHI',
...
export const KITS = [
  { id: 'none', label: '不裝', price: 0 },
  { id: 'little_d', demo: { color: 'ZZC', wheel: 'wildboar', rimColor: 0x1b1d1f, tyre: 't215r15', tread: 'bfg_km3' }, demoNote: '官方示範車：叢林綠、APIO WILDBOAR 15 吋、BFG 泥地胎 215/75R15', url: 'https://www.damd.co.jp/products/suzuki/jimny_sierra_little-d/', label: 'little D. Defender 風套件', price: 305800, cur: 'JPY', brand: 'DAMD',
  ...
  { id: 'little_g_trad', demo: { color: 'ZVG', wheel: 'oemsteel', rimColor: 0x1b1d1f, tyre: 't215r15', tread: 'toyo_mt' }, demoNote: '官網沒寫示範車顏色；我們配米色車身、黑色原廠鋼圈、215/75R15 泥地胎（示範車是同尺寸的 DUELER M/T）', url: 'https://www.damd.co.jp/products/suzuki/jimny_sierra_little-g_traditional/', label: 'little G. TRADITIONAL 套件', price: 547800, cur: 'JPY', brand: 'DAMD',
  ...
  { id: 'roots', demo: { color: 'ZZC', wheel: 'wildboar', rimColor: 0xd8d9d6, tyre: 't215r15', tread: 'bfg_km3' }, demoNote: '官網沒寫示範車顏色；我們配叢林綠車身，WILDBOAR 15 吋白框（官方有 Cotton White 色）與 215/75R15 泥地胎', url: 'https://www.damd.co.jp/products/suzuki/jimny_sierra_theroots/', label: 'JIMNY the ROOTS. LJ10 風套件', price: 213400, cur: 'JPY', brand: 'DAMD',
...
export const STYLES = [
  ...
  { id: 'jp_retro', label: '日系復古', sw: ['#d8c9a4', '#b4703a', '#1d2224'],
    ...
    set: { color: 'ZVG', lift: 'tg60', wheel: 'mrk_retro', tyre: 't215r16', tread: 'toyo_at3', owl: true, rimColor: 0x1b1d1f, stripe: 'retro3', grille: 'klc_sj', frontBumper: 'tube_heritage', rearBumper: 'klc_heritage_rear', mirrors: 'damd', sideStep: 'jst', ladder: 'jst', exhaust: 'hks_legal', sideSkirt: true } },
  ...
  { id: 'au_offroad', label: '澳洲越野', sw: ['#63645f', '#1d2224', '#d0621f'],
    ...
    set: { color: 'ZVL', lift: 'combo100', wheel: 'wildboar', tyre: 't31', tread: 'bfg_km3', rimColor: 0x1b1d1f, frontBumper: 'wmd_winch', rearBumper: 'hamer_mx208', grille: 'showa_hex', snorkel: 'safari', roofRack: 'arb', arbDeflector: true, arbBoards: true, awning: 'arb_touring_25', awningSide: 'left', sideStep: 'ironman', ladder: 'tube', roofLights: 'kc_pro6', windowGuards: true, guardCan: 'right', shovel: true, extinguisher: 'ladder', flares: true } },

  { id: 'city', label: '都會輕改', sw: ['#f2f3f0', '#8a6a3c', '#4a4d50'],
    desc: '日本車主最常見的那一套：白車、1 吋升高、深古銅 16 吋框配白字 KO2，KLC 短版前保桿配槍灰 JA 水箱罩、OUTCLASS 後保桿，加一道低腰銀線。比原廠精神、又不搶戲，車頂空的，機械車位進得去。',
    set: { color: 'ZVR', lift: 'klc30', wheel: 'bradley', tyre: 't215r16', tread: 'bfg_ko2', owl: true, rimColor: 0x8a6a3c, stripe: 'jaos', grille: 'klc_ja', frontBumper: 'klc_short', rearBumper: 'outclass_rear_abs', mirrors: 'damd', sideSkirt: true } },

  { id: 'military', label: '軍風', sw: ['#444a3a', '#e7e4da', '#5a5d5f'],
    desc: '原廠軍綠配白色軍卡模板字——後板序號、前葉子板 4x4，APIO SJ 槍灰鋼板水箱罩。方管前後桿、黑鋼圈泥地胎、平台車頂架，側窗鐵窗上掛油桶、斧頭與鏟子。',
    set: { color: 'ZZC', lift: 'td40', wheel: 'wildboar_sr', tyre: 't225r16', tread: 'bfg_km3', rimColor: 0x1b1d1f, stripe: 'stencil', grille: 'apio_sj', frontBumper: 'taniguchi_square', rearBumper: 'taniguchi_rear_pipe', roofRack: 'platform', windowGuards: true, guardCan: 'right', guardAxe: 'right', guardBoard: 'left', shovel: true, extinguisher: 'left', spareBag: true } },
  ...
  { id: 'street_low', label: '都會寬體低趴', sw: ['#16191c', '#6b5438', '#b8bcc0'],
    ...
    set: { color: 'ZJ3', lift: 'klc_turtles', wheel: 'street18', tyre: 't225r55', tread: 'toyo_ht2', fender: 'wald_bison', rimColor: 0x6b5438, grille: 'outclass_g', frontBumper: 'jaos_cowl', rearBumper: 'jaos_rear_cowl', exhaust: 'kakimoto_kr_lr', sideSkirt: true } },

  { id: 'narrow', label: '窄胎高瘦', sw: ['#0f74a8', '#d8d9d6', '#16191c'],
    desc: '原廠高度只換 185/85R16 窄高胎：胎比原廠瘦、又高一點，白字配白色鋼圈臉；水箱罩漆成車身藍、前後換 Beyond Liberte 復古保桿，整台車看起來更輕更高。輪胎配置照浜松 URBAN OFF CRAFT 的 JB74 實車配置。',
    set: { color: 'ZWY', twoTone: true, wheel: 'dean_cross', tyre: 't185r16', tread: 'toyo_rt', owl: true, rimColor: 0xd8d9d6, grille: 'prostaff_minig', frontBumper: 'beyond_liberte', rearBumper: 'beyond_rear' } },
  ...
  { id: 'cal_twotone', label: '加州雙色', sw: ['#e9dcc0', '#d0621f', '#d0d3d6'],
    ...
    set: { color: 'ZVG', split: 'orange', paintFlares: true, lift: 'klc30', wheel: 'super_moon', rimColor: 0xd0d3d6, tyre: 't215r16', tread: 'bfg_ko2', owl: true, frontBumper: 'beyond_liberte_mirror', rearBumper: 'beyond_rear_mirror', grille: 'klc_nanaketsu' } },
  ...
  { id: 'grey_purple', label: '灰紫時裝', sw: ['#8e8f8c', '#6a3a98', '#b8bcc0'],
    ...
    set: { color: 'ZVL', split: 'purple', paintFlares: true, lift: 'td40', wheel: 'mrk_retro', rimColor: 0xb8bcc0, tyre: 't225r16', tread: 'toyo_mt', frontBumper: 'beyond_liberte_mirror', rearBumper: 'beyond_rear_mirror', grille: 'klc_nanaketsu' } },

  { id: 'sunset_ja', label: '夕陽 JA11', sw: ['#f2f3f0', '#e0662a', '#1d2224'],
    desc: '白車配一整道橘紅棕漸層寬條紋，黑管桿、黑鋼圈，水箱罩上四顆琥珀燈——向 90 年代 JA11 致敬。照 Beyond CODE26。',
    set: { color: 'ZVR', stripe: 'toy4', lift: 'klc30', wheel: 'dean_cross', rimColor: 0x1b1d1f, tyre: 't215r16', tread: 'toyo_rt', owl: false, frontBumper: 'beyond_liberte', rearBumper: 'beyond_rear', grille: 'apio_marker' } },
  ...
  { id: 'cream_hw', label: '奶油硬件', sw: ['#444a3a', '#e9e1cc', '#f3c21c'],
    ...
    set: { color: 'ZZC', wheel: 'wildboar_sr', rimColor: 0xe9e4d6, tyre: 't215r16', tread: 'toyo_at3', owl: true, frontBumper: 'klc_trad', rearBumper: 'beyond_rear_ivory', roofRack: 'basket', rackPaint: 'ivory', lampCover: 'beyond_yellow', grille: 'klc_forty' } },
  ...
  { id: 'camp', label: '露營', sw: ['#cbd232', '#16191c', '#7a6242'],
    ...
    set: { color: 'ZZB', twoTone: true, lift: 'td60', wheel: 'xj07', tyre: 't225r16', tread: 'toyo_at3', rimColor: 0x7a6242, stripe: 'none', grille: 'taniguchi_washer', frontBumper: 'armando', rearBumper: 'wildgoose_box_rear', roofRack: 'pioneer', awning: 'yakima_270s', awningSide: 'left', sideStep: 'jst', ladder: 'jst', spareCover: true, extinguisher: 'ladder', flares: true } },
  ...
  { id: 'woodie', label: '木紋旅行車', sw: ['#16191c', '#8a5a32', '#d0d3d6'],
    ...
    set: { color: 'ZJ3', lift: 'klc30', wheel: 'super_moon', rimColor: 0xd0d3d6, tyre: 't215r16', tread: 'toyo_at3', owl: true, grille: 'klc_nanaketsu', roofRack: 'wood_full', mirrors: 'damd' } },
  ...
  { id: 'lc40', label: 'LC40 紅白', sw: ['#c81b22', '#f0f0ec', '#16191c'],
    ...
    set: { color: '2080-G13', lift: 'jaos40', wheel: 'watanabe_f8', rimColor: 0xf0f0ec, tyre: 't225r16', tread: 'toyo_mt', owl: true, grille: 'klc_forty', frontBumper: 'taniguchi_double', rearBumper: 'showa_iron_rear', sideStep: 'wildgoose_fold' } }
