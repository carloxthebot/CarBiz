...
export const WHEELS = [
  ...
  { id: 'maxx', photo: true, label: 'Flowforged 10 輻輪框', rim: 16, width: 7.0, offset: -10, needsFlares: true, style: 'ten',
...
export const FRONT_BUMPERS = [
  ...
  // ---- 台灣有售
  { id: 'tube_heritage', photo: true, url: 'https://www.klc-div.com/heritage/product/bumper/traditionalbumperfront_2_bk/', refs: ['https://www.klc-div.com/heritage/product/bumper/traditionalbumperfront_iv/', 'https://www.mrk.com.tw/product_ii.html?ID=561'], label: 'Traditional 雙管前保桿（黑）', price: 99000, cur: 'JPY', brand: 'KLC Heritage', photo: true,
  ...
  // ---- 日本
  { id: 'klc_nostalgic', photo: true, url: 'https://www.klc-div.com/heritage/product/bumper/nostalgicfrontbumper/', photo: true, label: 'Nostalgic 前保桿', price: 74800, cur: 'JPY', brand: 'KLC Heritage', uncertain: true,
    note: 'JA11 風壓鋼箱型桿、烤漆（顯示為車身同色），下方黑色飾板含圓霧燈；¥74,800–96,800 依塗裝' },
  { id: 'klc_short', photo: true, url: 'https://www.klc-div.com/heritage/product/bumper/frontshortbumper74/', photo: true, label: 'Front Short Bumper 74 前保桿', price: 96800, cur: 'JPY', brand: 'KLC Heritage', uncertain: true,
  ...
  { id: 'klc_trad', photo: true, url: 'https://www.klc-div.com/heritage/product/bumper/traditionalbumperfront_iv/', photo: true, label: 'Traditional 雙管前保桿（象牙白）', price: 104500, cur: 'JPY', brand: 'KLC Heritage',
...
export const REAR_BUMPERS = [
  ...
  { id: 'klc_heritage_rear', photo: true, url: 'https://www.klc-div.com/heritage/product/bumper/traditionalbumperrear_2_bk/', refs: ['https://www.mrk.com.tw/product_ii.html?ID=2059'], label: 'Traditional 雙管後保桿（黑）', price: 88000, cur: 'JPY', brand: 'KLC Heritage', part: 'HTRBBK', photo: true,
    note: '粗直管＋兩端梯形尾燈座板、車牌下吊；粉體黑／銀／象牙白（車主實車配置）' },
  { id: 'klc_nostalgic_rear', photo: true, url: 'https://www.klc-div.com/heritage/product/bumper/nostalgicrearbumper/', ownLamps: false, photo: true, label: 'Nostalgic 後保桿', price: 96800, cur: 'JPY', brand: 'KLC Heritage', uncertain: true,
...
export const SNORKELS = [
  ...
  { id: 'tw_cowl', photo: true, url: 'https://shopee.tw/product/44745815/26689961635',
    ...
    label: 'A 柱隱藏式涉水器', price: null, cur: 'TWD', brand: '蝦皮賣家（陸製）', uncertain: true,
    note: '不是管狀呼吸管：平貼式飾板取代 A 柱飾條，沿葉子板上緣往前接到空濾，進氣是鎖在 A 柱上段外側的長方形百葉面板（四角螺絲）。整組不高過雨槽，車高不變是它最大的賣點。車主實車配置；賣家未標製造商，尺寸依實照推估' },
...
export const OTHERS = [
  ...
  { id: 'trasharoo', key: 'spareBag', url: 'https://agileoffroad.com/products/trasharoo-spare-tire-trash-bag', label: '備胎書包（Trasharoo）', price: null, cur: 'USD', brand: 'Trasharoo', uncertain: true,
    note: '配置器「備胎書包」' },
  { id: 'maxx', photo: true, url: null, key: 'wheel', label: 'Flowforged 10 輻輪框 16×7.0J', price: null, cur: 'TWD', brand: 'MAXX', uncertain: true, note: '消光黑，配 TOYO Open Country M/T 225/75R16（車主實車配置）' },
];
