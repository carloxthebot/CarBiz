...
export const REAR_BUMPERS = [
  ...
  { id: 'beyond_rear', url: 'https://www.mrk.com.tw/product_ii.html?ID=2112', label: 'Beyond Japan Liberte 復古後保桿', price: 21000, cur: 'TWD', brand: 'Beyond Japan',
    note: '精簡鋼桿、消光黑' },
  { id: 'jaos_rear_cowl', url: 'https://www.mrk.com.tw/product_ii.html?ID=1176', label: 'JAOS Rear Sport Cowl', price: 26500, cur: 'TWD', brand: 'JAOS', part: 'B042518',
  ...
  { id: 'outclass_rear_abs', url: 'https://outclass.ocnk.net/product/1094', label: 'OUTCLASS Rear Bumper TYPE2 ABS', price: 45760, cur: 'JPY', brand: 'OUTCLASS',
    note: '精簡 ABS、小型尾燈' },
