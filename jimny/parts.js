...
export const WHEELS = [
  ...
  { id: 'wildboar', label: 'APIO WILDBOAR X', rim: 15, width: 6.0, offset: -5, needsFlares: true, style: 'eight',
  ...
  { id: 'maxx', photo: true, label: 'MAXX Flowforged 10 輻', rim: 16, width: 7.0, offset: -10, needsFlares: true, style: 'ten',
  ...
  { id: 'dean_cross', photo: false, url: 'https://www.dean-wheels.com/', label: 'DEAN Cross Country（中心板可拆）', rim: 16, width: 6.0, offset: -5, needsFlares: true, style: 'slot5',
  ...
  { id: 'super_moon', photo: false, url: 'https://shop.beyond-jpn.com/collections/%E3%83%9B%E3%82%A4%E3%83%BC%E3%83%AB', label: 'BeyondJAPAN SUPER MOON（月亮盤）', rim: 16, width: 6.0, offset: -5, needsFlares: true, style: 'moon',
  ...
  { id: 'wildboar_d', url: 'https://apio.jp/parts/7200-60.html', label: 'APIO WILDBOAR D（蓮根 16 孔）', rim: 16, width: 6.0, offset: -5, style: 'renkon',
    price: 48400, cur: 'JPY', brand: 'APIO', needsFlares: true,
    note: '碟面內凹，單圈 16 個錐形沉孔（蓮根紋），輪唇有對比色飾帶（煙燻透明或木紋銅）。無中心蓋、螺帽外露。2026-04 新品' },
  { id: 'wildboar_sr', url: 'https://apio.jp/parts/7200-28.html', label: 'APIO WILDBOAR SR（4 弧槽）', rim: 16, width: 6.0, offset: -5, style: 'arc4',
    price: 48400, cur: 'JPY', brand: 'APIO', needsFlares: true,
    note: '復古壓鋼圈造型：外圈平帶＋內凹中央盤，四道細長弧槽在 1:30／4:30／7:30／10:30，槽緣有滾邊。Iron Black／Iron Grey／Cotton White' },
  { id: 'xj07', url: 'https://www.mljinc.co.jp/product/xtreme-j/xj07/', label: 'MLJ XTREME-J XJ07（8 梯形窗）', rim: 16, width: 6.0, offset: -5, style: 'dwindow',
  ...
  { id: 'dean_california', url: 'https://www.dean-wheels.com/california/', label: 'DEAN California（24 槽渦輪面）', rim: 16, width: 6.0, offset: -5, style: 'turbine',
...
export const TYRE_MODELS = [
  ...
  { id: 'yk_g015', pattern: 'at', brand: 'YOKOHAMA', model: 'GEOLANDAR A/T G015', owl: false,
    label: 'Yokohama GEOLANDAR A/T G015', note: '**日規目錄沒有 195/80R15 也沒有 215/70R16**，實際可用的是 185/85R16（單面白字）；台灣不賣，已被 A/T4 G018 取代。部分尺寸白字' },
  ...
  { id: 'toyo_rt', photo: true, pattern: 'rt', brand: 'TOYO TIRES', model: 'OPEN COUNTRY R/T', owl: false,
    ...
    label: 'TOYO Open Country R/T', note: '白字**不在 JB74 主力尺寸**：官方表列 195/80R15 與 215/70R16 皆無 WL，白字在 185/85R16、LT225/70R16、235/70R16（零售 SKU 命名與官方表有衝突，待實車確認）。日規單面白字' },
  { id: 'yk_xat', pattern: 'rt', brand: 'YOKOHAMA', model: 'GEOLANDAR X-AT G016', owl: true,
    label: 'Yokohama GEOLANDAR X-AT', note: '白字的 JB74 尺寸是 **195/80R15（雙面白字）與 185/85R16**；LT215/70R16 是黑字。注意 195/80R15 是 **G016A**，兩面側壁設計與行銷照的 G016 不同。白字：195R16C、215/70R16' },
  { id: 'nt_ridge', unavailable: true, pattern: 'rt', brand: 'NITTO', model: 'RIDGE GRAPPLER', owl: false,
    label: 'Nitto Ridge Grappler', note: '**JB74 裝不上**：最小 265/70R16、最小輪圈 7.0J，原廠 5.5J 不合規。全 Grappler 系列也都沒有白字。留著僅供參考。僅黑字；JB74 常用尺寸較少' },
  { id: 'kd_rt', pattern: 'rt', brand: 'KENDA', model: 'KLEVER R/T', owl: true,
    label: 'Kenda Klever R/T KR601', note: '部分尺寸白字' },
  { id: 'toyo_mt', photo: true, pattern: 'mt', brand: 'TOYO TIRES', model: 'OPEN COUNTRY M/T', owl: false,
    mask: { file: 'toyo_mt.png', repeatMM: 246 },
    label: 'TOYO Open Country M/T', note: '白字依尺寸：**30×9.50R15 有、31×10.50R15 沒有**，美規全 BSW。JB74 可用尺寸全是 LT，都需要舉升。日規單面白字；LT 規格' },
  ...
  { id: 'yk_g003', pattern: 'mt', brand: 'YOKOHAMA', model: 'GEOLANDAR M/T G003', owl: false,
    label: 'Yokohama GEOLANDAR M/T G003', note: '**無白字**：Yokohama 明載「G003は全サイズ、レイズドブラックレター、リムプロテクトバー付」——任何市場任何尺寸都沒有白字。日規 215/70R16 有白字' },
  { id: 'cp_stt', pattern: 'mt', brand: 'COOPER', model: 'DISCOVERER STT PRO', owl: true,
    label: 'Cooper Discoverer STT Pro', note: 'JB74 只有 31×10.50R15 一個尺寸可用。31×10.5R15 白字' },
];
