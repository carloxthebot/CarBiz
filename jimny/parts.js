...
export const FRONT_BUMPERS = [
  ...
  // ---- 台灣有售
  { id: 'tube_heritage', label: 'KLC Heritage Traditional 圓管保桿（MRK 代理）', price: 104500, cur: 'JPY', brand: 'KLC Heritage',
    note: '不鏽鋼圓管＋Heritage 護板、車牌鎖管上、LED 方燈（車主實車配置）；台灣 MRK 4X4 代理' },
  { id: 'armando', label: 'ARMANDO PRIME 前鐵保桿（MRK）', price: 29000, cur: 'TWD', brand: 'ARMANDO',
    part: 'AR-SU-FB-PRM', note: '全寬鋼板保桿、中央燈架、圓霧燈孔、下護板' },
  { id: 'urnieta_1970', label: 'URNIETA 1970 前保桿', price: 20600, cur: 'TWD', brand: 'URNIETA', part: 'UR010',
    note: '短版復古、兩側上折收窄，保留原廠霧燈與洗燈' },
  { id: 'beyond_liberte', label: 'Beyond Japan Liberte 復古前保桿', price: 28000, cur: 'TWD', brand: 'Beyond Japan',
    note: '硬邊鋼製、霧燈架＋下護板；MRK 代理' },
  { id: 'maverick', label: 'Maverick 短版金屬前保桿（i-PICKUP）', price: 29000, cur: 'TWD', brand: 'Maverick',
    part: 'DF0001', note: '鍍鋅鋼 NT$29,000／鋁合金 NT$35,000，塗裝 +9,000' },
  { id: 'jst', label: 'JST 前保桿（黑四驅）', price: null, cur: 'TWD', brand: 'JST', uncertain: true,
    note: '短鋼板＋管狀護弓；報價制（估 NT$25–30k）' },
  { id: 'mrk_abs', label: 'MRK 短版 ABS 前保桿 消光黑', price: 9500, cur: 'TWD', brand: 'MRK', part: 'JMY-FB-L',
    note: '原廠造型縮短版、ABS' },
  { id: 'wmd_winch', label: 'WMD 前絞盤短保桿（機油倉庫）', price: 18000, cur: 'TWD', brand: 'WMD（台灣）',
    note: '台製鋼板、絞盤座、Ø50 護弓' },
  { id: 'jaos_cowl', label: 'JAOS Front Sport Cowl', price: 18700, cur: 'TWD', brand: 'JAOS', part: 'B040518',
  ...
  { id: 'klc_trad', label: 'KLC Heritage Traditional（象牙白）', price: 104500, cur: 'JPY', brand: 'KLC Heritage',
  ...
  { id: 'taniguchi_square', label: 'TANIGUCHI 角形前保桿', price: 58300, cur: 'JPY', brand: 'TANIGUCHI',
    note: '2mm 方管、粉體黑；不鏽鋼版 ¥107,800' },
  { id: 'taniguchi_double', label: 'TANIGUCHI 雙管前保桿', price: 77000, cur: 'JPY', brand: 'TANIGUCHI',
    note: '上下兩支 Ø48 圓管' },
  { id: 'toc_extreme', label: 'TOC BODYWORKS Extreme Bumper 74', price: 54780, cur: 'JPY', brand: 'TOC BODYWORKS',
...
export const REAR_BUMPERS = [
  ...
  { id: 'klc_heritage_rear', label: 'KLC Heritage 經典復古後保桿（MRK）', price: 26000, cur: 'TWD', brand: 'KLC Heritage',
    note: 'Ø60 直管、尾燈與車牌開口板；粉體黑／銀／象牙白' },
  { id: 'urnieta_1970_rear', label: 'URNIETA 1970 後保桿', price: 20400, cur: 'TWD', brand: 'URNIETA', part: 'UR015',
    note: '半高、兩端上折、圓形尾燈，8.4kg' },
  { id: 'beyond_rear', label: 'Beyond Japan Liberte 復古後保桿', price: 21000, cur: 'TWD', brand: 'Beyond Japan',
    note: '精簡鋼桿、消光黑' },
  { id: 'jaos_rear_cowl', label: 'JAOS Rear Sport Cowl', price: 26500, cur: 'TWD', brand: 'JAOS', part: 'B042518',
    note: 'PU 材質、4 顆圓形尾燈、倒車攝影機架' },
  // ---- 日本
  { id: 'wildgoose_crawler_rear', label: 'Wild Goose Crawler 後保桿 JM-1103', price: 66000, cur: 'JPY', brand: 'RV4 Wild Goose',
    note: 'Ø76.3 直管 1330×200×225、尾燈座 4.5mm 板、Ø50 拖環' },
  { id: 'wildgoose_box_rear', label: 'Wild Goose クロカン後保桿 JM-1101', price: 95700, cur: 'JPY', brand: 'RV4 Wild Goose',
    note: '1410×100×100 角形箱桿 3.2mm，13.2kg' },
  { id: 'showa_iron_rear', label: 'SHOWA GARAGE Iron Bumper Rear', price: 62150, cur: 'JPY', brand: 'SHOWA GARAGE',
    part: 'E00930', note: 'Ø60 主管＋Ø42 尾燈管翼；LED 倒車燈版 ¥127,930' },
  { id: 'taniguchi_rear_pipe', label: 'TANIGUCHI 越野後保桿（鋼管）', price: 63800, cur: 'JPY', brand: 'TANIGUCHI',
    note: '2.3mm 鋼管；角形版 ¥63,800、拖車鉤版 ¥128,700' },
  { id: 'apio_tactical_rear', label: 'APIO Tactical 後保桿', price: 140800, cur: 'JPY', brand: 'APIO', part: '3032-71',
    note: 'ABS 真空成形 1660×280×460，含燈殼與反光片；烤漆 +¥33,000' },
  { id: 'outclass_rear_abs', label: 'OUTCLASS Rear Bumper TYPE2 ABS', price: 45760, cur: 'JPY', brand: 'OUTCLASS',
    note: '精簡 ABS、小型尾燈' },
  { id: 'hamer_mx208', label: 'Hamer 4x4 MX208 後保桿', price: 1590, cur: 'AUD', brand: 'Hamer 4x4',
...
export const GRILLES = [
  ...
  // ---- 台灣有售
  { id: 'hbar_suzuki', label: '南國吉米 JB74 復古水箱罩（5 橫柵＋SUZUKI 白字）', price: 2750, cur: 'TWD', brand: '南國吉米（台灣）',
    note: 'ABS 消光黑；客製色 NT$4,500、草寫字版 NT$5,000（車主實車配置）' },
  { id: 'taishan_retro', label: '泰山美研社 復古水箱罩 黑／銀', price: 17500, cur: 'TWD', brand: '泰山美研社（台灣）',
    note: 'KLC 風格樹脂復古罩' },
  { id: 'urnieta_1970', label: 'URNIETA 1970 水箱護罩', price: 8400, cur: 'TWD', brand: 'URNIETA',
    note: '沖壓金屬網＋極簡框，1.6kg；Heekis 代理' },
  { id: 'mrk_angry', label: 'MRK 憤怒鳥款水箱罩', price: 5500, cur: 'TWD', brand: 'MRK', part: 'JB089',
    note: '3 道粗橫條、外端斜切、卡扣安裝' },
  { id: 'klc_sj', label: 'KLC Face Grille SJ（七孔＋SUZUKI 字）', price: 16000, cur: 'TWD', brand: 'KLC Heritage',
    note: 'FRP 素材 NT$16,000（藤井74）；日本 ABS 烤漆 ¥93,500。顯示為車身同色' },
  // ---- 日本
  { id: 'klc_ja', label: 'KLC Face Grille JA（JA22 風）', price: 93500, cur: 'JPY', brand: 'KLC Heritage',
    note: '大燈旁雙燈座、中央開放網；ABS 素材 ¥60,500／FRP ¥55,000' },
  { id: 'klc_nanaketsu', label: 'KLC Face Grille NANAKETSU（七穴）', price: 93500, cur: 'JPY', brand: 'KLC Heritage',
    note: '7 個圓角方孔、銀色鋁網' },
  { id: 'klc_forty', label: 'KLC Face Grille FORTY（FJ40 風）', price: 93500, cur: 'JPY', brand: 'KLC Heritage',
    note: '大燈周圍肋條、中央網＋S 標' },
  { id: 'apio_sj', label: 'APIO SJ Grille', price: 58300, cur: 'JPY', brand: 'APIO', part: '3033-58G',
    note: 'SJ30 直縫沖壓鋼板、槍灰、黑鋁網' },
  { id: 'apio_marker', label: 'APIO Marker Vintage Iron Grille', price: 75900, cur: 'JPY', brand: 'APIO', part: '3033-59',
  ...
  { id: 'taniguchi_washer', label: 'TANIGUCHI FRP Washer Grille', price: 44000, cur: 'JPY', brand: 'TANIGUCHI',
    note: '原廠造型 FRP、洗燈噴嘴移入大燈' },
  { id: 'kpro_folksy', label: 'K-PRODUCTS Folksy Style 橫鰭護罩', price: 30000, cur: 'JPY', brand: 'K-PRODUCTS', uncertain: true,
    note: 'FRP 白膠殼、橫向鰭片' },
  { id: 'prostaff_minig', label: 'Pro Staff miniG Grille', price: 38000, cur: 'JPY', brand: 'Pro Staff', uncertain: true,
    note: 'G-Class 直縫' },
  { id: 'sixsense_explosion', label: 'Six Sense Explosion Classic', price: 80000, cur: 'JPY', brand: 'Six Sense', uncertain: true,
...
export const ROOF_RACKS = [
  { id: 'none', label: '無', price: 0 },
  // ---- 台灣有售
  { id: 'arb', label: 'ARB BASE Rack 1545×1285', price: 45000, cur: 'TWD', brand: 'ARB', part: '1770020 + 17900020',
    note: '鋁擠型平台、燕尾槽側軌、4 支雨槽腳；平台單品 NT$15,000（MRK）；車主實車配置' },
  { id: 'yakima', label: 'Yakima LockNLoad 平台 B 1520×1370', price: 23000, cur: 'TWD', brand: 'Yakima', part: '8005045',
    note: '橫向板條 T 槽、4 支雨槽腳（110／150／210mm）；Yakima 台灣售價' },
  { id: 'pioneer', label: 'Rhino-Rack Jimny Overlanding Kit（Pioneer LT）', price: 58300, cur: 'TWD', brand: 'Rhino-Rack',
    part: 'ROLS1', note: '1453×1339、5 道縱向板條、Backbone 橫樑固定；黑四驅售價' },
  { id: 'ipf', label: 'IPF EXP Roof Rack type-A', price: 32000, cur: 'TWD', brand: 'IPF', part: 'EXR-01',
    note: '1400×1250×38.8、12.5kg；日本 ¥85,800、MRK 台灣售價' },
  { id: 'tw_generic', label: '機油倉庫 鋁合金平頂行李架', price: 13000, cur: 'TWD', brand: '機油倉庫（台灣）',
    note: '1600×1260、6 支雨槽腳、前導流板；安裝 +NT$1,000' },
  // ---- 進口
  { id: 'platform', label: 'Front Runner Slimline II 全長', price: 1579, cur: 'AUD', brand: 'Front Runner', part: 'KRSJ003T',
    note: '1560×1345、6 支雨槽腳、前導流板，31kg' },
  { id: 'fr34', label: 'Front Runner Slimline II 3/4', price: 1451, cur: 'AUD', brand: 'Front Runner', part: 'KRSJ006T',
    note: '1156×1345、4 支腳' },
  { id: 'jaos', label: 'JAOS Flat Rack type-B', price: 140800, cur: 'JPY', brand: 'JAOS', part: 'B411611NS',
    note: '1400×1250×32、6 道 T 槽底桿、前導流板；type-A ¥116,600' },
  { id: 'apio', label: 'APIO Mighty Smart Rack', price: 231000, cur: 'JPY', brand: 'APIO', part: '3630-50',
    note: '1420×1270、前軌前傾兼導流、船用鋁粉體' },
  { id: 'showa_foot', label: 'SHOWA GARAGE A-x Roof Rack 1512', price: 92400, cur: 'JPY', brand: 'SHOWA GARAGE',
    part: 'E20080', note: '1500×1250×40 噴砂鋁面' },
  { id: 'basket', label: 'SHOWA GARAGE A-x Full Rack M（籃式）', price: 68200, cur: 'JPY', brand: 'SHOWA GARAGE',
...
export const AWNINGS = [
  { id: 'none', label: '無', price: 0 },
  // ---- 台灣有售
  { id: 'yakima_s', label: 'Yakima OverNOut S 2×2.5m', price: 8500, cur: 'TWD', brand: 'Yakima', part: 'KT8007508',
    note: '軟袋 2100 長、12kg；Yakima 台灣售價' },
  { id: 'yakima_l', label: 'Yakima OverNOut L 2.5×2.5m', price: 11700, cur: 'TWD', brand: 'Yakima', part: 'KTHB0019',
    note: '軟袋 2600 長、18kg' },
  { id: 'yakima_270', label: 'Yakima OverNOut 270 蝙蝠帳', price: 21600, cur: 'TWD', brand: 'Yakima', part: '8007462/3',
    note: '2286×216×254、後端旋轉、四支臂自撐；左＝駕駛側' },
  { id: 'yakima_180', label: 'Yakima OverNOut 180', price: 21600, cur: 'TWD', brand: 'Yakima', part: '8007516',
    note: '2260×229×178、8.7m²、三支臂' },
  { id: 'rhino_compact', label: 'Rhino-Rack Batwing Compact 蝙蝠帳', price: 33920, cur: 'TWD', brand: 'Rhino-Rack',
    part: '33120/33121', note: '2000 長、6m²、18kg；黑四驅售價' },
  { id: 'rhino_270', label: 'Rhino-Rack Batwing 270', price: 38160, cur: 'TWD', brand: 'Rhino-Rack', part: '33118/33119',
    note: '2500 長、10m²、20.5kg' },
  { id: 'allblack_270', label: '黑四驅 ALL BLACK 270° 車邊帳 gen3', price: 18000, cur: 'TWD', brand: '黑四驅（台灣）',
    note: '2m／2.5m 兩種、左開／右開；含 LED 燈條' },
  // ---- 進口
  { id: 'arb_touring_2', label: 'ARB Touring 2000×2500 LED', price: null, cur: 'AUD', brand: 'ARB', part: '814406', uncertain: true,
    note: 'PVC 軟袋約 2200 長，12.9kg；經銷商報價' },
  { id: 'arb_touring_25', label: 'ARB Touring 2500×2500 LED', price: null, cur: 'AUD', brand: 'ARB', part: '814407', uncertain: true,
    note: '約 2700 長，14.3kg' },
  { id: 'arb_alu', label: 'ARB 鋁殼車邊帳 2500×2500', price: null, cur: 'AUD', brand: 'ARB', part: '814412', uncertain: true,
    note: '矩形鋁殼、外側掀蓋，17.8kg' },
  { id: 'darche_270', label: 'Darche Eclipse 270 G2', price: 1499, cur: 'AUD', brand: 'Darche', part: 'T050801743',
    note: '11.5m²、1000D PVC，後端鋁合金旋軸' },
  { id: 'darche_slim', label: 'Darche Eclipse Slimline 2.5×2.5', price: 579, cur: 'AUD', brand: 'Darche', part: 'T050801793',
    note: '820D 軟袋，14kg' },
  { id: 'ikamper', label: 'iKamper ExoShell 270', price: 1950, cur: 'USD', brand: 'iKamper', part: 'MB011-002',
...
export const SIDE_STEPS = [
  { id: 'none', label: '無', price: 0 },
  // ---- 台灣
  { id: 'wlm', label: 'WLM 4x4 側踏保桿 WLM001', price: 13800, cur: 'TWD', brand: 'WLM 4x4',
    note: 'Ø50 圓管貼門檻、兩片踏板、鍍鋅粉體黑；用原廠孔位免鑽孔' },
  { id: 'jst', label: 'JST 吉米工坊 側踏保桿 JB74001', price: 8500, cur: 'TWD', brand: 'JST 吉米工坊',
    note: '加強型／特仕版 NT$8,500–11,700；直管＋兩片平踏板' },
  { id: 'tjm', label: 'TJM Rock Slider（MRK 代理）', price: 18000, cur: 'TWD', brand: 'TJM',
    part: '735STRSA57X', note: 'Ø51 大樑固定、焊接踏板；支架另購 NT$3,000' },
  // ---- 日本
  { id: 'outclass', label: 'OUTCLASS サイドステップ', price: 88000, cur: 'JPY', brand: 'OUTCLASS',
    note: '低矮管架＋平板踏面，兼門檻保護；消光黑或 Raptor 塗層' },
  { id: 'apio_guard', label: 'APIO H.D サイドシルガード', price: 132000, cur: 'JPY', brand: 'APIO', part: '3102-69',
    note: '1350×185 雙層 3mm 硬鋁門檻護甲（無踏板）；窄體限定' },
  { id: 'jaos', label: 'JAOS サイドステップ', price: 121000, cur: 'JPY', brand: 'JAOS', part: 'B172522BK',
    note: 'Ø76.3 粗管＋樹脂踏墊，16.7kg；規格表標 JC74，請確認適用' },
  { id: 'taniguchi_bar', label: 'TANIGUCHI サイドステップ バータイプ', price: 53900, cur: 'JPY', brand: 'TANIGUCHI',
    note: '長管＋550×145 網狀踏板，兩段高度可調；左 ¥50,600' },
  { id: 'taniguchi_short', label: 'TANIGUCHI 2段調整サイドステップ', price: 41250, cur: 'JPY', brand: 'TANIGUCHI',
    note: '車門下短網踏 550×145；不鏽鋼版 ¥59,400' },
  { id: 'showa', label: 'SHOWA GARAGE サイドステップ ロング Type2', price: 69300, cur: 'JPY', brand: 'SHOWA GARAGE',
    part: 'E00173', note: '純圓管、皺紋黑；JB74 需另購飾板 E00207' },
  { id: 'wildgoose_fold', label: 'Wild Goose 折疊式踏板 JM-2262', price: 35200, cur: 'JPY', brand: 'RV4 Wild Goose',
    note: '單邊價；510mm 寬 4.2mm 鋼板、可上翻' },
  { id: 'wildgoose_guard', label: 'Wild Goose サイドシルガードステップ JM-2409', price: 110000, cur: 'JPY',
    brand: 'RV4 Wild Goose', note: '1292 長、外凸 55mm 的門檻護甲，可踩；14.5kg' },
  { id: 'customwagon', label: 'Custom Wagon 出幅調整サイドステップ', price: 57200, cur: 'JPY', brand: 'Custom Wagon',
    note: '弧形圓管＋花紋踏板，出幅約 50mm 可調' },
  { id: 'spieler', label: 'SPIELER サイドステップ 7575', price: 88000, cur: 'JPY', brand: 'SPIELER',
    note: '75×75 方管＋鋁面板，用車廂固定孔免鑽' },
  // ---- 澳洲
  { id: 'arb', label: 'ARB Rock Slider', price: 891, cur: 'AUD', brand: 'ARB', part: '4424010',
    note: 'Ø60.3 主管、3 支支撐管接大樑、紋理黑，18kg' },
  { id: 'ironman', label: 'Ironman 4x4 Rock Slider SS070', price: 699, cur: 'AUD', brand: 'Ironman 4x4',
    note: 'Ø50.8×2.6、1280mm、緞面黑' },
  { id: 'hamer', label: 'Hamer 4x4 SM104 Rock Slider', price: null, cur: 'AUD', brand: 'Hamer 4x4', uncertain: true,
    note: '圓管＋格柵踏板，25kg，報價制' },
];

export const LADDERS = [
  { id: 'none', label: '無', price: 0 },
  { id: 'fr', label: 'Front Runner 尾門梯', price: null, cur: 'AUD', brand: 'Front Runner', part: 'LASJ004', uncertain: true,
    note: '4 階、鉸鏈側、勾尾門上緣' },
