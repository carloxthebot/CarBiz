...
export const KITS = [
  ...
  { id: 'urnieta_salado', demo: { color: 'ZVG', lift: 'td40', wheel: 'maxx', rimColor: 0x1b1d1f, tyre: 't225r16', tread: 'bfg_ko2', owl: true }, demoNote: '官網沒寫示範車配置；我們配米色車身、40mm 舉升、黑框 225/75R16 白字全地形胎', url: 'https://urnieta.com/', label: 'SALADO 遠征越野套件', price: null, cur: 'TWD', brand: 'URNIETA', uncertain: true,
  ...
  { id: 'urnieta_1970', demo: { color: 'ZZB', twoTone: true, wheel: 'dean_cross', rimColor: 0xd8d9d6, tyre: 't215r16', tread: 'toyo_at3', owl: true }, demoNote: '官網沒寫示範車顏色；我們配黃黑雙色車身、白色 DEAN 鋼圈臉、215/70R16 白字胎', url: 'https://urnieta.com/', label: '1970 復古套件（70 年代風）', price: 49400, cur: 'TWD', brand: 'URNIETA',
...
export const STYLES = [
  ...
  { id: 'au_offroad', label: '澳洲越野', sw: ['#3f4a3c', '#1d2224', '#8a6b45'],
    ...
    set: { color: 'ZVR', lift: 'combo100', wheel: 'wildboar', tyre: 't31', tread: 'bfg_km3',
